...
.c-search-bar {
  @apply relative flex items-center rounded-full bg-white px-4 py-3 outline outline-2 outline-transparent transition-all ease-out-relax duration-300;
  ...
  &__input {
    @apply flex-1 text-base font-medium placeholder-gray-400 text-gray-600 focus:outline-none;
  }

  &__icon {
    @apply w-5 h-5 fill-slate-600 mr-3 cursor-pointer;
  }
}
</style>
