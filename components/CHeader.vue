...
<template>
  <header class="c-header">
    <div class="c-header__body">
      ...
      <nav class="c-header__box-search-bar">
        <CSearchBar
      ...
      <nav class="c-header__actions">
        ...
        <CButton v-if="!isSignedIn" class="c-header__btn-join">Login</CButton>
...
.c-header {
  @apply w-full flex items-center justify-center fixed top-0 z-20 bg-pink-lady-50;

  &__body {
    @apply w-full max-w-[1212px] px-4 py-5 flex items-center;
  }
  ...
  &__actions {
    @apply flex items-center justify-end space-x-3.5 flex-1;
  }
